...
export const SOLAR: ChainTokenMap = {
  ...
  [ChainId.MATIC_TESTNET]: new Token(ChainId.MATIC_TESTNET, SOLAR_ADDRESS[ChainId.MATIC_TESTNET], 18, 'SOLAR', 'Solarbeam Token'), // Changed this
}
...
export const WETH9_EXTENDED: { [chainId: number]: Token } = {
  ...
  [SupportedChainId.MATIC_TESTNET]: new Token(
