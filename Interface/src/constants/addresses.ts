...
export const TIMELOCK_ADDRESS: AddressMap = {
  ...
  [ChainId.MATIC_TESTNET]: '0xAADa433A386a5521502ee3A3e064461CD37dbC9F', // Changed this
}
...
export const LOCKER_ADDRESS: AddressMap = {
  ...
  [ChainId.MATIC_TESTNET]: '0xa6998813709A68C9b37BCc9511521a7021cFB896', // Changed this
}
...
export const SOLAR_DISTRIBUTOR_ADDRESS: AddressMap = {
  ...
  [ChainId.MATIC_TESTNET]: '0x1cB2B70196F107845f479bDB3A8CF0EFe64E6616', // Changed this
}

export const SOLAR_VAULT_ADDRESS: AddressMap = {
  [ChainId.MOONRIVER]: '0x7e6E03822D0077F3C417D33caeAc900Fc2645679',
  [ChainId.MATIC_TESTNET]: '0x1cB2B70196F107845f479bDB3A8CF0EFe64E6616', // Does not exist, need to check
}
...
export const MULTICALL2_ADDRESS: AddressMap = {
  ...
  [ChainId.MATIC_TESTNET]: '0x5625b03De42553340E70CaD2fFED8ef581F449Bc', // Changed this
