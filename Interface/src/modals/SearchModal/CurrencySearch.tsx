      ...
      {!currencyList && (
        <div className="mt-3 mb-8">
          <input
            ...
            className="w-full bg-transparent border border-dark-500 focus:border-transparent focus:border-gradient-r-pink-dark-900 rounded placeholder-secondary focus:placeholder-primary font-bold text-base px-3 py-3"
          />
        </div>
      )}
