...
contract VarietyToken is ERC20, ERC20Permit, Pausable, AccessControl {
    ...
    uint256 private _initialSupply = 1000000 * 10**decimals(); // 1000,000 tokens is the initial supply
    ...
    constructor(address trustedForwarder) ERC20("Variety Token", "VAR") ERC20Permit("Variety Token") {
