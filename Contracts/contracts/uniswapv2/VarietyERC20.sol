...
contract VarietyERC20 {
    using SafeMathVariety for uint;

    string public constant name = 'Variety LP Token';
    ...
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) external {
        require(deadline >= block.timestamp, 'Variety: EXPIRED');
        ...
        require(recoveredAddress != address(0) && recoveredAddress == owner, 'Variety: INVALID_SIGNATURE');
